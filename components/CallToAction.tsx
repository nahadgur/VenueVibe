  ...
  return (
    <section className="py-28 bg-[#EDE5D8] relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <motion.div initial={{ opacity: 0, scale: 0.97 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ duration: 0.8, ease: 'easeOut' }} className="bg-white border border-[#E0D5C5] rounded-2xl p-8 sm:p-12 md:p-20 relative overflow-hidden">
          <p className="text-[#D4654A] text-[11px] tracking-[0.25em] uppercase font-medium mb-6">Join the community</p>
          <h2 className="text-3xl sm:text-4xl md:text-6xl font-[Georgia,serif] font-normal text-[#2C2418] mb-6 tracking-tight leading-tight">Elevate your <br className="hidden md:block" /><span className="italic text-[#8C7B66]">experience</span></h2>
