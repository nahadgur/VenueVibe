              ...
              <div className="flex flex-col sm:flex-row">
                ...
                <div className="flex-1 p-5 flex flex-col sm:flex-row sm:items-center gap-4">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <Link
                      href={`/venue/${venue.id}`}
                      className="px-4 py-2 rounded-lg border border-[#E0D5C5] text-[12px] text-[#5C4E3C] font-light hover:border-[#C4AE8F] transition-colors flex items-center gap-1.5"
                    >
                    ...
                    <div className="relative">
                      <button
                        ...
                        className="p-2 rounded-lg border border-[#E0D5C5] text-[#A69580] hover:border-[#C4AE8F] hover:text-[#5C4E3C] transition-colors"
                      >
